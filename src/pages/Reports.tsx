...
const Reports = () => {
  ...
  const generateCustomReport = () => {
    if (customDateFrom && customDateTo) {
      ...
      console.log('Generating custom report from', customDateFrom, 'to', customDateTo);
...
Date: ${new Date().toLocaleDateString()}
    ...
    a.href = url;
    a.download = `Report_${report.patientName.replace(' ', '_')}_${report.date}.txt`;
        ...
        <Card className="bg-white shadow-sm mb-6 sm:mb-8">
          ...
          <CardContent className="p-4 sm:p-6 pt-0">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
              <Button 
                variant="outline" 
                className="h-auto p-3 sm:p-4 flex-col text-center"
                onClick={() => setShowWeeklyModal(true)}
              >
                <CalendarIcon className="h-6 w-6 sm:h-8 sm:w-8 mb-2 text-blue-600" />
                <span className="font-semibold text-sm sm:text-base">Weekly Summary</span>
                <span className="text-xs sm:text-sm text-gray-600 mt-1">Generate this week's report</span>
              </Button>
              <Button 
                variant="outline" 
                className="h-auto p-3 sm:p-4 flex-col text-center"
              ...
              >
                <BarChart3 className="h-6 w-6 sm:h-8 sm:w-8 mb-2 text-green-600" />
                <span className="font-semibold text-sm sm:text-base">Monthly Analytics</span>
                <span className="text-xs sm:text-sm text-gray-600 mt-1">Detailed monthly insights</span>
              </Button>
              <Button 
                variant="outline" 
                className="h-auto p-3 sm:p-4 flex-col text-center sm:col-span-2 lg:col-span-1"
                onClick={() => setShowCustomModal(true)}
              >
                <FileText className="h-6 w-6 sm:h-8 sm:w-8 mb-2 text-purple-600" />
                <span className="font-semibold text-sm sm:text-base">Custom Report</span>
                <span className="text-xs sm:text-sm text-gray-600 mt-1">Create custom date range</span>
              </Button>
            </div>
          </CardContent>
        </Card>
